		...
		if (e.getSource() == tela.getTxtNomeProduto()) {
			...
			try {
					...
					if(!nomeProduto.equals("NOME DO PRODUTO") && !nomeProduto.isBlank()
							&& !precoProduto.equals("PREÇO DO PRODUTO") && !precoProduto.isBlank()) {
						...
						JOptionPane.showMessageDialog(null, "Dados inválidos.", "Atenção", 2, null);
					}
				} catch (Exception e2) {
					JOptionPane.showMessageDialog(null, "Selecione um produto.", "Atenção!", 2, null);
				}
